...
public class Player implements Bot {
    ...
    private enum Strategy {FOLDER, WATCHERFOLD, WATCHERAGGRESSIVE, AGGRESSIVE}
    
    //Maps strategies to their associated starting cards
    //e.g AGGRESSIVE would be mapped to [Ac,As] 
    private Map<Strategy, String[][]> startingCards = 
            Map.of(
                    Strategy.FOLDER, new String[][] {
                        {},
                        {}
                    });
    ...
    public Player() {
        ...
        this.strategy = Strategy.WATCHERFOLD;
